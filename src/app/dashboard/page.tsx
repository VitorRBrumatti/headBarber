...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      {/* Decorative Footer Visual */}
      <section className="grid grid-cols-4 gap-6 opacity-30 pointer-events-none pb-8 pt-4">
        <div className="h-1.5 w-full bg-[#c8c5cb] rounded-full"></div>
        <div className="h-1.5 w-full bg-[#c8c5cb] rounded-full"></div>
        <div className="h-1.5 w-full bg-[#c8c5cb] rounded-full"></div>
        <div className="h-1.5 w-full bg-[#c8c5cb] rounded-full"></div>
      </section>
